...
namespace Tests.UpdaterTests
{
    public class UpdaterTests
    {
        ...
        public async Task GetLatestReleaseAsync_ReturnsLatestRelease()
        {
            ...
            var updater = new XiaomiSoftwareManager.Updater();
        ...
        public void FormatBytes_ReturnsCorrectFormat()
        {
            // Arrange
            var updater = new XiaomiSoftwareManager.Updater();
            var privateMethod = typeof(XiaomiSoftwareManager.Updater).GetMethod("FormatBytes", BindingFlags.NonPublic | BindingFlags.Instance)!;
        ...
        public void FormatBytesPerSecond_ReturnsCorrectFormat()
        {
            // Arrange
            var updater = new XiaomiSoftwareManager.Updater();
            var privateMethod = typeof(XiaomiSoftwareManager.Updater).GetMethod("FormatBytesPerSecond", BindingFlags.NonPublic | BindingFlags.Instance)!;
                ...
                Assets = new List<GitHubAsset>
        {
            ...
            var updater = new XiaomiSoftwareManager.Updater();
            var downloadFolderField = typeof(XiaomiSoftwareManager.Updater).GetField("downloadFolder", BindingFlags.NonPublic | BindingFlags.Instance);
